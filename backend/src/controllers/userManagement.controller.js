...
class UserManagementController {
  async list(req, res, next) {
    try {
      ...
      const { limit, offset, search, role, includeInactive, academicYearId } = req.query;
      const result = await userManagementService.list(schoolId, { limit, offset, search, role, includeInactive: includeInactive === 'true', academicYearId });

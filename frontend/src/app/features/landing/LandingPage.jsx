          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative reveal">
              <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl animate-float">
                <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20" />
              </div>
              <div
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-full bg-${t.avatar} flex items-center justify-center text-white font-semibold text-lg`}
                  >
                    {t.name.charAt(0)}
                  </div>
                  <div>

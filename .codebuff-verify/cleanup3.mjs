...
(async () => {
  const del = await sql`DELETE FROM timetable_periods WHERE school_id = 'e4fd54e7-9d78-4620-8e78-1c92e8238197' AND academic_year_id = '59942741-bd76-4afe-b288-69dd5710f830'`;
  console.log("nettoyés:", del.count);
  process.exit(0);
